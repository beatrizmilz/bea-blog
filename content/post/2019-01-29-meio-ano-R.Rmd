...
```{r }
knitr::include_graphics("https://beatrizmilz.github.io/img/rladies-1-meetup.jpeg")
```
...
```{r}
knitr::include_graphics("https://beatrizmilz.github.io/img/rladies_codata.jpg") 
```
...
```{r out.width="30%"}
knitr::include_graphics("https://beatrizmilz.github.io/img/hacktoberfest.jpg")
```